...
# -----------------------------------------------------------------------------
st.sidebar.image("https://i.imgur.com/3ZQ3Z6N.png", width=180)  # optional logo
st.sidebar.title("GridScout AI")
st.sidebar.markdown("Camden County demo – score & filter parcels for clean‑energy siting.")
...
only_buildable = st.sidebar.checkbox("Buildable only (IS_VALID = 1)", True)
